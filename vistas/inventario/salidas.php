...
include '../../controladores/crud_salidas.php';
 ...
 while($row = mysqli_fetch_assoc($roles35))
  { 
      $id_rol7 = $row['ID_ROL'];
               ...
               $proveedor = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=35 and PERMISO_CONSULTAR=0";
               ...
               if (mysqli_num_rows($proveedor2) > 0)
               {
                ...
                $role = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=35 and PERMISO_CONSULTAR=1";
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <form id="form" action="" method="post">
                    ...
                    <?php 
      include '../../conexion/conexion.php';
      $area1 = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=35 and PERMISO_INSERCION=1";
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td class="desaparecerTemporalmente">
                          ...
                          <?php 
                          include '../../conexion/conexion.php';
                          $proveedor = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=35 and PERMISO_ELIMINACION=1";
                          $proveedor2 = mysqli_query($conn, $proveedor);
                          if (mysqli_num_rows($proveedor2) > 0)
                          {?>
                            <form action="" method="post">
                            <input type="hidden" name="id_productoss" value="<?php echo $filas['ID_PRODUCTOSS'] ?>">
                                <input type="hidden" name="cantidad" value="<?php echo $filas['CANTIDAD_BAJA'] ?>">
                          <input type="hidden" name="id_bajas_herramientas"  value="<?php echo $filas['ID_BAJAS_HERRAMIENTAS'] ?>">
                    ...
                    <?php 
                        ...
                        ?>
                                         ...
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['ID_BAJAS_HERRAMIENTAS'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['NOMBRE_PRODUCTO'] ?></td>
                                         <td class="desaparecerTemporalmente1" style="text-align: right;"><?php echo $filas['CANTIDAD_BAJA'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['DESCRIPCION_BAJAS'] ?></td>
...
<script>
  $(function () {
                          ...
                          buttons:[ 
    {
            ...
            title:     'REPORTE DE OTRAS SALIDAS',
            exportOptions: {
                columns: [1,2,3,4,5,6]
            }
    },
  ...
  $(".desaparecerTemporalmente").css("display","none");
          ...
          columnStyles: {    
			...
			for(var i = 1; i <= pageCount; i++) 
			{
				...
				pdf.setFont('times');
				pdf.setFontSize(12);
				pdf.text("Reporte de otras salidas", pdf.internal.pageSize.getWidth() / 2, 20, null, 'center');
        ...
        // pdf.text(245-25,297-281,"<?php echo 'Creado por:'. $_SESSION['usuario']; ?>");
				...
				//Fin Encabezado y pie de pagina
							...
							pdf.save('Reporte de otras salidas.pdf');
