...
include '../../controladores/crud_regalias.php';
 ...
 while($row = mysqli_fetch_assoc($roles35))
  { 
      $id_rol7 = $row['ID_ROL'];
               ...
               $proveedor = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=34 and PERMISO_CONSULTAR=0";
               ...
               if (mysqli_num_rows($proveedor2) > 0)
               {
                ...
                $role = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=34 and PERMISO_CONSULTAR=1";
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <form id="form" action="" method="post">
                    ...
                    <?php 
      include '../../conexion/conexion.php';
      $area1 = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=34 and PERMISO_INSERCION=1";
      ...
      if (mysqli_num_rows($area2) > 0)
       {
         echo '<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#myModal">
                    Nueva entrada
                        ...
                        ?> 
              <button type="submit"  name="accion" value="reporte_pdf" class="btn btn-secondary buttons-pdf buttons-html5"  onclick="return confirm('¿Quieres generar reporte de otras entradas?')" onclick="textToPdf()"><span>Reporte PDF</span></button>
	               </div>
            </form>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td class="desaparecerTemporalmente">
                          ...
                          <?php 
                          include '../../conexion/conexion.php';
                          $proveedor = "SELECT * FROM tbl_ms_roles_ojetos WHERE ID_ROL='$id_rol7' and ID_OBJETO=34 and PERMISO_ELIMINACION=1";
                          $proveedor2 = mysqli_query($conn, $proveedor);
                          if (mysqli_num_rows($proveedor2) > 0)
                          {?>
                            <form action="" method="post">
                            <input type="hidden" name="id_productoss" value="<?php echo $filas['ID_PRODUCTOSS'] ?>">
                                <input type="hidden" name="cantidad" value="<?php echo $filas['CANTIDAD_REGALIA'] ?>">
                          <input type="hidden" name="id_regalia"  value="<?php echo $filas['ID_REGALIA'] ?>">
                    ...
                    <?php 
                        ...
                        ?>
                                         ...
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['ID_REGALIA'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['NOMBRE_PRODUCTO'] ?></td>
                                         <td class="desaparecerTemporalmente1" style="text-align: right;"><?php echo $filas['CANTIDAD_REGALIA'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['DESCRIPCION_REGALIA'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['USUARIO'] ?></td>
                                         <td class="desaparecerTemporalmente1"><?php echo $filas['FECHA_REGALIA'] ?></td>
...
<script>
  $(function () {
                          ...
                          buttons:[ 
    {
            ...
            title:     'REPORTE DE OTRAS ENTRADAS',
            exportOptions: {
                columns: [1,2,3,4,5,6]
            }
    },
  ...
  $(".desaparecerTemporalmente").css("display","none");
          ...
          columnStyles: {    
			...
			for(var i = 1; i <= pageCount; i++) 
			{
				...
				pdf.setFont('times');
				pdf.setFontSize(12);
				pdf.text("Reporte de otras entradas", pdf.internal.pageSize.getWidth() / 2, 20, null, 'center');
        ...
        // pdf.text(245-25,297-281,"<?php echo 'Creado por:'. $_SESSION['usuario']; ?>");
				...
				//Fin Encabezado y pie de pagina
							...
							pdf.save('Reporte de otras entradas.pdf');
