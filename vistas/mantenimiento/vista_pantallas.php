...
include '../../controladores/crud_pantalla.php';
            ...
            <div class="card table-responsive">
              ...
              <div class="card-body ">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <th>Acciones</th>
                  <th>Id</th>
                  <th>Nombre de la Pantalla</th>
                  <th>Descripcion de la Pantalla</th>
                  <th>Tipo de la Pantalla</th>
                  ...
                  <td>
                                 ...
                                 <!-- inicio boton editar -->
                      <button type="button"  class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#myModal2<?php echo $filas['ID_OBJETO'] ?>" disabled>
                          ...
                          <div class="modal" id="myModal2<?php echo $filas['ID_OBJETO'] ?>">
                            <div class="modal-dialog">
                              <div class="modal-content">
                                ...
                                <form action="" method="post">
                                          <div class="modal-body">
                                            <input type="hidden" name="nombre_anterior" value="<?php echo $filas['OBJETO'] ?>">
                                              <label for="">Id objeto:</label>
                                              <input type="text" readonly class="form-control" name="id_objeto" required value="<?php echo $filas['ID_OBJETO'] ?>" placeholder=""  >
                                              <br>
                                              <label for="">Nombre de la Pantalla:</label>
                                              <input type="text" class="form-control" name="objeto" required value="<?php echo $filas['OBJETO'] ?>" placeholder=""  autocomplete = "off"  onkeypress="return soloLetras(event);" minlength="3" maxlength="100" 
                                                onkeyup="mayus(this);" required >
                                              <br> 
                                              <label for="">Descripcion de la Pantalla:</label>
                                              <input type="text" class="form-control" name="descripcion" required value="<?php echo $filas['DESCRIPCION'] ?>" placeholder=""  autocomplete = "off"  onkeypress="return soloLetras(event);" minlength="3" maxlength="100" 
                                                onkeyup="mayus(this);" required >
                                                <br> 
                                              <label for="">Tipo de la Pantalla:</label>
                                              <input type="text" class="form-control" name="tipo_objeto" required value="<?php echo $filas['TIPO_OBJETO'] ?>" placeholder=""  autocomplete = "off"  onkeypress="return soloLetras(event);" minlength="3" maxlength="40" 
                                               onkeyup="mayus(this);" required > 
                                          </div>
                                <!-- Fin Cuerpo del modal Modal -->
                     ...
                     <td ><?php echo $filas['ID_OBJETO'] ?></td>
                     <td><?php echo $filas['OBJETO'] ?></td>
                     <td ><?php echo $filas['DESCRIPCION'] ?></td>
                     <td><?php echo $filas['TIPO_OBJETO'] ?></td>
