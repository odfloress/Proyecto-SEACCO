...
<body class="w3-light-grey">
      ...
      <!-- Header -->
        ...
        <img class="w3-image" src="../../imagenes/fondo.jpg" alt="The Hotel" style="min-width:100%" width="100%" height="100%">
            ...
            <form action="/action_page.php" target="_blank">
                  <div class="w3-row-padding" style="margin:0 -16px;">
                    ...
                    <div class="w3-half w3-margin-bottom">
                      ...
                      <input type="text" class="w3-input w3-border" placeholder="Ingre su nombre" name="nombre" required>
                    </div>
                      <div class="w3-half">
                        <label for="">Apellido</label>
                        <input type="text" class="w3-input w3-border" placeholder="Ingre apellido" name="apellido" required>
                      </div>
                  </div>
                <div class="w3-row-padding" style="margin:8px -16px;">
                      ...
                      <div class="w3-row-padding" style="margin:8px -16px;">
                        ...
                        <!-- Numero de Tel y correo -->
                        <div class="w3-half w3-margin-bottom">
                          <label for="">Correo</label>
                          <input type="mail" class="w3-input w3-border" placeholder="Opcional Ingrese su correo" name="email">
                        </div>
                            <div class="w3-half">
                      ...
                      <div class="w3-row-padding" style="margin:8px -16px;">
                          <div class="w3-half w3-margin-bottom">
                            ...
                            <select  name="txtMetodo_Compra" class="w3-input w3-border" value="<?php echo "$depto"; ?>" class="form-select" id="lista1" required="true">
                                  <?php
                            ...
                            <option  value="">Seleccione su Departamento</option>
                                <!-- <option  value="">FCO MORAZAN </option>
                                <option  value="">EL PARAISO</option>
                            ...
                            <!-- <input type="text" class="w3-input w3-border" placeholder="Seleccione un Departamento"> -->
                  ...
                  <div class="w3-row-padding" style="margin:8px -16px;">
                    <div class="w3-half w3-margin-bottom">
                      ...
                      <!-- <input type="text" class="w3-input w3-border" placeholder="Descripción breve de su solicitud" >  -->
